...
async def workcontrol(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    lines=["👩‍💼 <b>PRIYA — WORK CONTROL</b>","🧩 Sprint 14.0 Dynamic Case Ownership","",
...
async def reconcileassignments(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.effective_message.reply_text(f"✅ Court-floor ownership recalculated for {count} live hearing case(s).")
